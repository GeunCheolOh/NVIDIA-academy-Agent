...
# YOUR CODE HERE - with st.sidebar:를 사용하여 사이드바 구성
# with st.sidebar:
#     st.header("⚙️ 설정 패널")
#     
#     st.subheader("모델 설정")
...
# YOUR CODE HERE - st.tabs()를 사용하여 4개의 탭 생성
...
# YOUR CODE HERE - with st.expander()를 사용하여 확장 가능한 섹션 생성
...
# YOUR CODE HERE - st.container(border=True)를 사용하여 컨테이너 생성
